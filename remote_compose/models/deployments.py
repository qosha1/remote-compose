...
class Deployment(TimestampedModel):
    ...
    project_name = models.CharField(
        max_length=255,
        blank=True,
        help_text='Docker Compose project name'
    )
    ...
    environment = models.JSONField(
        default=dict,
        blank=True,
        help_text='Environment variables passed to deployment'
    )
    ...
    service_status = models.JSONField(
        default=dict,
        blank=True,
        help_text='Per-service status information'
    )
    ...
    def succeed(self, container_ids=None, service_status=None):
        ...
        self.save(update_fields=[
            'status', 'completed_at', 'container_ids',
...
class DeploymentLog(models.Model):
    ...
    service_name = models.CharField(
        max_length=255,
        blank=True,
        help_text='Specific service if applicable'
    )
    ...
    @classmethod
    def log(cls, deployment, message, level='info', command='', output='', service_name=''):
