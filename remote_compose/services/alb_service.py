...
class ALBService(BaseService):
    ...
    def provision_alb(
        ...
        """
        elbv2 = self.aws_factory.get_client('elbv2', region=region, credential=credential)
        ...
        if existing_alb:
            ...
            return self._sync_alb_to_db(cluster, existing_alb, security_group_id, certificate_arn)
    ...
    def _wait_for_alb_active(
        ...
        raise ALBProvisioningError(
            f"Timeout waiting for ALB to become active",
            alb_arn=alb_arn,
        )
