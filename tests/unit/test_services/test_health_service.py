...
class TestHealthService:
    ...
    def test_check_all_targets_health(self, service):
        ...
        with (
            patch.object(DeploymentTarget.objects, "all") as mock_all,
            ...
            mock_check.side_effect = [
                ...
                HealthCheckResult(
                    healthy=False, target_name="target2", message="failed"
                ),
            ]
    ...
    def test_check_deployment_health_services_running(self, service, mock_deployment):
        ...
        with (
            patch.object(service, "target_service") as mock_ts,
    ...
    def test_check_deployment_health_services_not_running(
        self, service, mock_deployment
    ):
