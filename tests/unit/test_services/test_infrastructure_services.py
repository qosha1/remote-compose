...
class TestSecurityGroupService:
    ...
    def test_provision_creates_five_security_groups(
        ...
        result = sg_service.provision_security_groups(cluster, vpc_id="vpc-test123")
    ...
    def test_configure_rules_handles_duplicate_rules(
        ...
        mock_ec2_client.authorize_security_group_ingress.side_effect = (
            _make_client_error(
...
class TestSecretsService:
    ...
    def test_get_or_create_secret_creates_new(
        ...
        assert (
            arn
            == "arn:aws:secretsmanager:us-east-1:123:secret:test-cluster/DB_PASSWORD-abc"
        )
    ...
    def test_get_or_create_secret_updates_existing(
        ...
        assert (
            arn
            == "arn:aws:secretsmanager:us-east-1:123:secret:test-cluster/API_KEY-xyz"
        )
...
class TestServiceConnectService:
    ...
    def test_get_or_create_namespace_creates_new(
        ...
        mock_sd_client.create_http_namespace.return_value = {"OperationId": "op-123"}
    ...
    def test_get_or_create_namespace_reuses_existing_db_record(
        ...
        mock_sd_client.get_namespace.return_value = {"Namespace": {"Id": "ns-existing"}}
    ...
    def test_get_or_create_namespace_removes_stale_db_record(
        ...
        mock_sd_client.create_http_namespace.return_value = {"OperationId": "op-new"}
        mock_sd_client.get_operation.return_value = {
            "Operation": {
                "Status": "SUCCESS",
        ...
        def _get_namespace(**kwargs):
            call_count["n"] += 1
            if call_count["n"] == 1:
                raise _make_client_error("NamespaceNotFound", "Gone", "GetNamespace")
